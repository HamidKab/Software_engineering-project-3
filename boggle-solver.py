...
"""
the class Trienode
initializes the children stored in the trie.
"""
...
"""
the Trie
initializes the root by calling trienode.
There are multiple functions within the class,
which include: Insert, starts with, and is_word.
"""
...
"""
 This class handles a large chunk of what we need the boggle to do.
 The class first initializes a grid, rows, columns, a dictionary, and set.
 Within the initialization we iterate over the words in the dictionary
 and capitalize each word and check to see if the length is over 3 characters.
 If the word meets these conditions it is inserted into the trie.
 The boggle class has a handful of classes that make it work,
 those classes being: setGrid, setDict, getSolution, and _solve.
"""
